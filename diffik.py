...
def main() -> None:
    ...
    model = mujoco.MjModel.from_xml_path("/home/emlyn/rl_franka/environments/INB0104/Robot_C.xml")
    data = mujoco.MjData(model)

    # Set PD gains.
    Kp = np.asarray([4500, 4500, 3500, 3500, 2000, 2000, 2000, 100])
    Kd = np.asarray([450, 450, 350, 350, 200, 200, 200, 100])
